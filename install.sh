...
wget https://github.com/BishopFox/sliver/releases/download/$VER/sliver-server_linux
wget https://github.com/BishopFox/sliver/releases/download/$VER/sliver-client_linux
